...
<head>
    ...
    <title>Projekt "GoodNight" | Mikołaj Golański</title>
    <style>
        body {
            color: #fff;
            background: #86a4f3;
...
<main class="container my-5">
    <section class="section">
        <h2><?= $lang == 'pl' ? 'Projekt "GoodNight"' : 'Project "GoodNight"' ?></h2>
        <p><?= $lang == 'pl' ? 'Inteligentny budzik budzący użytkownika obliczając fazy REM.' : 'An intelligent alarm clock that wakes the user by calculating REM phases.' ?></p>
        <p><?= $lang == 'pl' ? 'Opis projektu...' : 'Welcome to the GoodNight project! This mobile application is designed for both iOS and Android platforms, aiming to enhance the users waking experience by aligning the alarm with their sleep cycles. By doing so, GoodNight ensures that users wake up feeling more refreshed and well-rested.' ?></p>
        <img id="gn" src="photos/goodnight.png" alt="GoodNight Project Image" class="img-fluid" />
        <a href="https://github.com/WojteGK/GoodNight-Project" class="btn btn-primary"><?= $lang == 'pl' ? 'Zobacz kod na GitHubie' : 'View code on GitHub' ?></a>
    </section>
