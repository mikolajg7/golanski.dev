...
<main class="container my-5">
    <section class="section">
        <h2><?= $lang == 'pl' ? 'Algorytm rozpoznawania tablicy rejestracyjnej' : 'License Plate Recognition Algorithm' ?></h2>
        <p><?= $lang == 'pl' ? 'Algorytm rozpoznawania tablicy rejestracyjnej ze zdjęcia.' : 'An algorithm for recognizing license plates from a photo.' ?></p>
        <p><?= $lang == 'pl' ? 'Opis projektu...' : 'This project focuses on license plate recognition using computer vision techniques and OCR (Optical Character Recognition). The provided code implements various image processing steps, including gamma correction, edge detection, contour detection, and cropping to isolate license plate regions from images. The project also utilizes Tesseract OCR for text extraction from license plate images. By combining these techniques, the project aims to accurately detect and extract license plate information from images.' ?></p>
        <img id="lp" src="photos/tablice-rejestracyjne.png" alt="Licence plate Image" class="img-fluid" />
        <a href="https://github.com/mikolajg7/license_number_plate_recognition" class="btn btn-primary"><?= $lang == 'pl' ? 'Zobacz projekt na GitHubie' : 'View project on GitHub' ?></a>
    </section>
