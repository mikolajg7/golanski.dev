...
<head>
    ...
    <title>SpeedTypingApp | Mikołaj Golański</title>
    <style>
        body {
            color: #fff;
            background: #86a4f3;
...
<main class="container my-5">
    <section class="section">
        <h2>SpeedTypingApp</h2>
        <p><?= $lang == 'pl' ? 'Prosta aplikacja do sprawdzenia prędkości pisania wraz z nauką odpowiedniego kliknięcia palcem na przycisk.' : 'A simple application to test typing speed along with learning the correct finger to button click.' ?></p>
        <p><?= $lang == 'pl' ? 'Opis projektu...' : 'Simple Speed Typing App designed to check typing speed and also includes learning features to teach which finger should press each key. Currently in the building phase, the app is only available in Polish, but English language support will be added in the future.' ?></p>
        <a href="https://github.com/mikolajg7/SpeedTypingApp" class="btn btn-primary"><?= $lang == 'pl' ? 'Zobacz projekt na GitHubie' : 'View project on GitHub' ?></a>
    </section>
