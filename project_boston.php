...
<main class="container my-5">
    <section class="section">
        <h2><?= $lang == 'pl' ? 'Boston Housing - analiza oraz predykcja.' : 'Boston Housing Data Analysis and Prediction' ?></h2>
        <p><?= $lang == 'pl' ? 'Algorytm rozpoznawania tablicy rejestracyjnej ze zdjęcia.' : 'This project is a comprehensive analysis and prediction of the Boston Housing dataset. It includes data cleaning, exploratory data analysis, visualization, and predictive modeling using linear regression.' ?></p>
